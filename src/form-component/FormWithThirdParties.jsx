...
export const FormWithThirdParties = ({ formDisplayMethods, options }) => {
  ...
  return (
    ...
    >
      ...
      >
        Use your email or another service to continue with MadeMyWay.
      </p>
      ...
      >
        <X color="var(--light-text)" size={30} />
      </Button>
    </FormContainer>
  );
};
