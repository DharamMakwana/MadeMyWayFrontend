...
import { multipleImagesUploadToCloudinary } from "../../utils/multipleImagesUploadToCloudinary";
...
const AddSitePage = () => {
  ...
  const handleFormSubmit = async (data) => {
    ...
    try {
      ...
      const placeDetails = await setDoc(doc(db, "Places", place_id), {
        place_id,
  ...
  return (
    <FormConatiner>
      ...
      >
        ...
        <MultiSelectBadges register={register} setValue={setValue} />
